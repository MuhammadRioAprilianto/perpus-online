 ...
 *
 * Provides a centralized function to render inline SVG icons
 * throughout the application views. All icons use 24x24 viewBox
 * and accept custom CSS classes for sizing and styling.
 */

/**
 * Render an SVG icon by name with optional CSS class.
 *
...
function renderIcon(string $name, string $class = 'w-5 h-5'): string
{
    $icons = [
        ...
        'menu-catalog' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16"/>',
        ...
        'food' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4m0 0L7 13m0 0l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17M17 13v4a1 1 0 01-1 1H8a1 1 0 01-1-1v-4"/>',

        'eye-off' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.878 9.878L6.59 6.59m7.532 7.532l3.29 3.29M3 3l18 18"/>',
    ...
    return '<svg xmlns="http://www.w3.org/2000/svg" class="' . $class . '" fill="none" viewBox="0 0 24 24" stroke="currentColor">' . $path . '</svg>';
}
