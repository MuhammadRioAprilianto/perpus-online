    ...
    <div class="min-h-screen flex flex-col md:flex-row">
        ...
        <aside class="w-full md:w-64 bg-white shadow-sm border-r border-gray-100 flex flex-col">
            ...
            <nav class="p-4 space-y-2 flex-1">
                <a href="/perpus-online/public/admin/dashboard" class="block p-3 rounded-xl hover:bg-base hover:text-primary transition-all duration-300 text-gray-500 font-medium">
                    Dashboard
                </a>
                <a href="/perpus-online/public/admin/books" class="block p-3 rounded-xl bg-primary text-white shadow-md shadow-primary/30 transition-all duration-300 font-medium">
                    Manajemen Buku
                </a>
