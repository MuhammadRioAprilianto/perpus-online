    ...
    <div class="min-h-screen flex flex-col md:flex-row">
        ...
        <main class="flex-1 p-6 md:p-12">
            ...
            <div class="mb-10">
                ...
                <h1 class="text-3xl font-extrabold tracking-tight text-slate-900">Ubah Data Buku</h1>
                <p class="text-slate-400 text-sm mt-1.5 font-medium">Ubah rincian informasi dan gambar sampul untuk buku: <span class="text-slate-800 font-bold"><?= htmlspecialchars($book['title']) ?></span></p>
            </div>
                ...
                <form action="/perpus-online/public/admin/books/edit?id=<?= $book['id'] ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-2 md:col-span-2">
                            <label for="title" class="block font-bold text-xs uppercase tracking-wider text-slate-400">Judul Buku</label>
                            <input type="text" id="title" name="title" required value="<?= htmlspecialchars($book['title']) ?>"
                                class="w-full px-4 py-3.5 rounded-2xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all bg-slate-50 focus:bg-white text-sm font-semibold text-slate-850">
                        </div>

                        <div class="space-y-2">
                            <label for="author" class="block font-bold text-xs uppercase tracking-wider text-slate-400">Penulis / Pengarang</label>
                        ...
                        <div class="space-y-2">
                            <label for="stock" class="block font-bold text-xs uppercase tracking-wider text-slate-400">Jumlah Stok</label>
                        ...
                        <div class="space-y-2 md:col-span-2">
                            <label for="cover_image" class="block font-bold text-xs uppercase tracking-wider text-slate-400">Gambar Sampul Baru (Opsional)</label>
                            ...
                            <p class="text-[10px] text-slate-400 mt-1.5 font-medium">Biarkan kosong jika tidak ingin mengganti gambar sampul.</p>
                        </div>
                    </div>
