        ...
        <div class="flex-grow flex flex-col min-h-screen">
            <main class="flex-grow p-6 md:p-12">
                ...
                <div class="mb-10">
                    ...
                    <h1 class="text-3xl font-extrabold tracking-tight text-slate-900 dark:text-white">Tambah Buku Baru</h1>
                    <p class="text-slate-400 dark:text-slate-400 text-sm mt-1.5 font-medium">Isi rincian buku fisik di bawah ini untuk didaftarkan ke katalog publik.</p>
                </div>
                ...
                <div class="bg-white dark:bg-slate-900 rounded-3xl shadow-sm border border-slate-200 dark:border-slate-800 p-8 max-w-3xl transition-colors">
                    <form action="<?= BASE_URL ?>/admin/books/add" method="POST" enctype="multipart/form-data" class="space-y-6">
                        
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            
                            <div class="space-y-2 md:col-span-2">
                                <label for="title" class="block font-bold text-xs uppercase tracking-wider text-slate-400 dark:text-slate-400">Judul Buku <span class="text-rose-500">*</span></label>
                                <input type="text" id="title" name="title" required 
                                    class="w-full px-4 py-3.5 rounded-2xl border border-slate-200 dark:border-slate-700 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all bg-slate-50 dark:bg-slate-950 focus:bg-white dark:focus:bg-slate-900 placeholder-slate-400 text-slate-700 dark:text-slate-200 text-sm font-semibold"
                                    placeholder="Contoh: Pemrograman Web Lanjut">
                            </div>

                            <div class="space-y-2">
                                <label for="author" class="block font-bold text-xs uppercase tracking-wider text-slate-400 dark:text-slate-400">Penulis / Pengarang <span class="text-rose-500">*</span></label>
                            ...
                            <div class="space-y-2">
                                <label for="stock" class="block font-bold text-xs uppercase tracking-wider text-slate-500 dark:text-slate-400">Jumlah Stok <span class="text-rose-500">*</span></label>
                            ...
                            <div class="space-y-2 md:col-span-2">
                                <label for="cover_image" class="block font-bold text-xs uppercase tracking-wider text-slate-500 dark:text-slate-400">Gambar Sampul Buku</label>
                                ...
                                <p class="text-[10px] text-slate-400 dark:text-slate-500 mt-1.5 font-medium">Mendukung format JPG, PNG, WEBP. Maksimal ukuran file 2MB.</p>
                            </div>
                        </div>
