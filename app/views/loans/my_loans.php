            ...
            <div class="flex items-center gap-5">
                ...
                <div class="relative inline-block text-left" id="user-menu-wrapper">
                    ...
                    <div id="user-dropdown-menu" class="origin-top-right absolute right-0 mt-3.5 w-56 rounded-3xl shadow-xl bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700/80 py-2.5 z-50 hidden transition-all duration-200 scale-95 opacity-0 transform">
                        ...
                        <?php else: ?>
                            <a href="<?= BASE_URL ?>/loans" class="flex items-center gap-3.5 px-5 py-3 text-sm font-bold text-primary dark:text-indigo-400 hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors">
                                <?= renderIcon('clipboard', 'w-4 h-4 text-primary dark:text-indigo-400') ?>
        ...
        <div class="space-y-6" id="loans_container">
            <?php if(empty($loans)): ?>
                <div class="bg-white dark:bg-slate-800 rounded-3xl shadow-sm border border-slate-200 dark:border-slate-700/50 p-12 text-center flex flex-col items-center justify-center">
                    ...
                    <a href="<?= BASE_URL ?>/catalog" class="bg-primary hover:bg-opacity-95 text-white px-8 py-3.5 rounded-2xl font-bold transition-all duration-300 shadow-lg hover:-translate-y-0.5 text-sm">Lihat Katalog</a>
                </div>
            <?php else: ?>
